---
description: Generate or modify code using OpenAI Codex. Use for creating new files, implementing features, fixing bugs, refactoring, etc. Results are always returned as structured JSON.
allowed-tools:
